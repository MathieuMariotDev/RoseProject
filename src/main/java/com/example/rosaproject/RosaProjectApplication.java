...
public class RosaProjectApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Entreprise entreprise = new Entreprise("www.monlogo.com","La redoute","00123659895","Lentreprise@entreprise.com","+33750828587","+33233657895","www.monsite.com","16 rue de la chambre","batiment 3","Nantes","78000","Vente de vêtement", LocalDate.now(),user);
